...
class _chatingState extends State<chating> {
  ...
  var specialistFname = "";
  var specialistLname = "";
  var specialistFullName = "";
  String specialistID = "";
  String parentID = "";

  void _getSpecialistName() async {
        ...
        if (querySnapshot.docs.length > 0) {
          ...
          if (documentSnapshot.exists) {
            setState(() {
              ...
              specialistFullName = specialistFname + " " + specialistLname;
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            //             return Image.asset(
            //               'assets/usman-yousaf-pTrhfmj2jDA-unsplash.jpg',
            //               fit: BoxFit.cover,
            //             );
            //           }),
            //     ),
                    ...
                    try {
                      ...
                      for (var message in messages) {
                        if ((message.get('sender') == parentID &&
                            ...
                            (message.get('sender') == specialistID &&
