...
class _editProfileState extends State<editProfile> {
  ...
  bool IbanActiveButton = false;
  bool bioActiveButton = false;
  bool isFnameNew = false;
  bool isLnameNew = false;
  bool isPhoneNew = false;
  bool isIbanNew = false;
  bool isBioNew = false;
  late String PN;
  ...
  //       .collection('users')
  //       .doc('user_id')
  //       .update({'profile_photo': _imageUrl});
  // }
  ...
  void deleteAccount() async {
    final collectionRef = FirebaseFirestore.instance.collection('specialist');
  ...
  bool isActivated() {
    ...
    bool isIbanFormatValid =
        RegExp(r'^[A-Z]{2}[0-9]{2}[a-zA-Z0-9]{4}[0-9]{7}[a-zA-Z0-9]{0,16}$')
            .hasMatch(IbanController.text);

    // Validate Bio format
    bool isBioFormatValid =
        RegExp("[a-zA-Z\u0621-\u064A]+").hasMatch(bioController.text);
                                ...
                                Container(
                                  ...
                                  child: Form(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onChanged: (value) {
                                        setState(() {
                                          LnameActiveButton = LnameformKey
                                              .currentState!
                                              .validate();
                                ...
                                Container(
                                  ...
                                  child: Form(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onChanged: (value) {
                                        setState(() {
                                          FnameActiveButton = FnameformKey
                                              .currentState!
                                              .validate();
                          ...
                          child: Form(
                            ...
                            child: TextFormField(
                              ...
                              validator: (value) {
                                ///
                                if (value!.isEmpty || value == null) {
                                  bioActiveButton = false;
                                  print("bio Empty");
                                  return "الـرجـاء إدخـال النبذة الشخصية";
                                } else {
                                  bool isValid =
                                      RegExp("[a-zA-Z\u0621-\u064A]+")
                                          .hasMatch(value);
                                  if (!isValid) {
                                    bioActiveButton = false;
                                    return "الرجاء ادخال النبذة بشكل صحيح";
                                  } else
                                    bioActiveButton = true;
                                  print("bio not Empty");
                                  print("bio new");
                                }
                              },
                              onChanged: (value) {
                                setState(() {
                                  bioActiveButton = value.isNotEmpty;
                                  bool isValid =
                                      RegExp("[a-zA-Z\u0621-\u064A]+")
                                          .hasMatch(value);
                        ...
                        Container(
                          ...
                          child: Form(
                            ...
                            child: TextFormField(
                              ...
                              //   FilteringTextInputFormatter.allow(
                              //     RegExp(
                              //         r'^[A-Z]{2}[0-9]{2}[a-zA-Z0-9]{4}[0-9]{7}[a-zA-Z0-9]{0,16}$'),
                              //   ),
                              // ],
                              ...
                              validator: (value) {
                                ///
                                if (value!.isEmpty || value == null) {
                                  IbanActiveButton = false;
                                  print("Fname Empty");
                                  return "الـرجـاء إدخـال الايبان";
                                } else {
                                  bool isValid = RegExp(
                                          r'^[A-Z]{2}[0-9]{2}[a-zA-Z0-9]{4}[0-9]{7}[a-zA-Z0-9]{0,16}$')
                                      .hasMatch(value);
                                  if (!isValid) {
                                    IbanActiveButton = false;
                                    return "صيغة الايبان غير صحيحة";
                                  } else
                                    IbanActiveButton = true;
                                  print("IBAN not Empty");
                                  print("IBAN new");
                                }
                              },
                              onChanged: (value) {
                                setState(() {
                                  IbanActiveButton = value.isNotEmpty;
                                  bool isValid = RegExp(
                                          r'^[A-Z]{2}[0-9]{2}[a-zA-Z0-9]{4}[0-9]{7}[a-zA-Z0-9]{0,16}$')
                                      .hasMatch(value);
                                  if (value.isNotEmpty && !isValid) {
                                    IbanformKey.currentState!.validate();
                                  }
                                });
                              },
                              decoration: InputDecoration(
                                hintText: "أدخل الايبان البنكي هنا",
